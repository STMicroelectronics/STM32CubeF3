# BSP STM32F3DISCOVERY Component

![latest tag](https://img.shields.io/github/v/tag/STMicroelectronics/stm32f3discovery.svg?color=brightgreen)
...
This **stm32f3discovery** MCU component repository is one element of the **STM32CubeF3** MCU embedded software package, providing the **STM32F3DISCOVERY** BSP BOARD component part.

## Release note

Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/stm32f3discovery/blob/main/Release_Notes.html).
